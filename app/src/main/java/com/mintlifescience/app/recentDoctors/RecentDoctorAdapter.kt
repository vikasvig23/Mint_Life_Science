...
class RecentDoctorAdapter(private var docList: List<DoctorData>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        RecentDoctorViewHolder(LayoutInflater.from(parent.context)
    ...
    override fun onBindViewHolder(holder: RecentDoctorViewHolder, position: Int) {
        ...
        if (doctor.havePresentation && doctor.scheduleMeet.isNotEmpty()) {
            ...
            val meetMs = try {
                ...
                Log.e("RecentDoctorAdapter", "Date parse failed: ${doctor.scheduleMeet}", e)
                null
            }
            if (meetMs != null) {
        ...
        holder.cardDoc.setOnClickListener {
            ...
            intent.putExtra("recentDoctor", true)
